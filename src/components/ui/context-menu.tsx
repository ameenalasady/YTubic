...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        // `gap-2` matches every other row in both menu families. Upstream
        // omits it here, which left "Add to playlist" with its icon jammed
        // against its label while the items above and below lined up.
...
function ContextMenuSubContent({
  ...
  return (
    ...
    // (frostedSurface) plus `overflow-y-auto`. A backdrop-filter makes
